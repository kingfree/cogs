...
<td class=admin><a href="../admin/comp/editcompbase.php?action=edit&cbid=<?=$d['cbid']?>">修改<?=$d['cbid']?></a></td>
<td class=admin><a href="../admin/comp/editcomptime.php?action=edit&ctid=<?=$d['ctid']?>">编辑<?=$d['ctid']?></a></td>
<? } ?>
</tr>
<? } ?>
</table>

...
<table width="100%" border="1"  bordercolor=#000000  cellspacing=0 cellpadding=4>
  ...
  <tr>
    <td>组名</td>
    <td>
      <input name="gname" type="text" id="gname" value="<?php echo $d[gname] ?>"></td>
  </tr>
  <tr>
    <td>上级分组</td>
...
?>
  ...
  <tr>
    <td>管理员uid</td>
    <td><input name="adminuid" type="text"  id="adminuid" value="<?php echo $d['adminuid'] ?>"></td>
  </tr>
  <tr>
    <td>备注</td>
  ...
  <input type="submit" name="Submit" value="提交修改" class="btn" />
</form>

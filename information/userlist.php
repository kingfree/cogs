...
<table width="100%" border="1" >
  <tr>
    ...
    <th scope="col" bgcolor="#99FFCC">真实姓名</th>
    <th scope="col" bgcolor="#99FFCC">IP</th>
    <th scope="col" bgcolor="#99FFCC">操作</th>
...
<a href="../user/detail.php?uid=<?php echo $d['uid'] ?>" target="_blank"><?php echo $d['nickname'] ?></a></td>
    ...
    <td bgcolor="#99FFCC"><a href="../addons/ipquery/?ip=<?php echo $d['lastip'] ?>" target="_blank"><?php echo $d['lastip'] ?></a></td>
    <td bgcolor="#99FFCC">

...
<p>
<span class='tou'><?=date('Y-m-d H:i:s',time())?></span>
以 <a href="http://getbootstrap.com/" target="_blank">Twitter Bootstrap</a> 作为界面框架，应用 <a href="/Bootstrap/css/<?=$_SESSION['user_style']?>.min.css" target="_blank"><?=$_SESSION['user_style']?></a> 主题。
<?php echo 输出文本("进程运行 %processtime% s ，处理完成数据库 %querytimes% 次。") ?>
</p>
<?php echo 输出文本($SET['global_tail']) ?>
由 <a href="https://github.com/kingfree/cogs" target="_blank">CmYkRgB123 在线评测系统</a> 强力驱动，版本 <?php echo $cfg['Version']; ?> ，由 <a href="mailto:cogs@kingfree.moe" target="_blank">王者自由</a> 二次开发。原作者 &copy; <a href="http://www.byvoid.com" target="_blank">BYVoid</a>，保留部分权利。
</p>
</div>
</div>
<? /*
